...
**Technologies:** Solidity, OpenZeppelin, Aave and Uniswap integration, Hardhat, Ethers.js, Mocha
...
**Technologies:** Solidity, OpenZeppelin, Chainlink VRF, Hardhat, Ethers.js, Next.js, Moralis, The Graph, IPFS
...
**Technologies:** Solidity, Chainlink VRF, Chainlink Automation, Hardhat, Ethers.js, Next.js, Mocha, Moralis, IPFS
